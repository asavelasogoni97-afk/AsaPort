    ...
    <section id="about" className="min-h-screen flex items-center justify-center px-4 sm:px-6 py-20 sm:py-32">
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="space-y-6 sm:space-y-8 text-white/80 text-base sm:text-lg md:text-xl leading-relaxed font-mono">
          <div 
            className="border-l-4 border-green-500 p-4 sm:p-6 rounded-r-xl backdrop-blur-md shadow-lg"
            style={{
          ...
          <div 
            className="border-l-4 border-blue-500 p-4 sm:p-6 rounded-r-xl backdrop-blur-md shadow-lg"
            style={{
              background: 'rgba(0, 0, 0, 0.3)',
              backdropFilter: 'blur(10px)',
              WebkitBackdropFilter: 'blur(10px)',
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-3 sm:gap-4 justify-center sm:justify-start">
                  {['Java', 'Python', 'JavaScript', 'C++', 'C#', 'SQL', 'TypeScript'].map((skill) => (
                    <span
                      key={skill}
                      className="px-4 sm:px-6 py-2 sm:py-3 border border-green-500/30 text-green-400 hover:border-green-500 hover:bg-green-500/10 transition-all duration-300 text-sm sm:text-base font-mono rounded-lg"
                    >
                      {skill}
                    </span>
                  ))}
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-3 sm:gap-4 justify-center sm:justify-start">
                  {['AWS', 'Azure', 'Agile', 'SSIS', 'CI/CD'].map((skill) => (
                    <span
                      key={skill}
                      className="px-4 sm:px-6 py-2 sm:py-3 border border-blue-500/30 text-blue-400 hover:border-blue-500 hover:bg-blue-500/10 transition-all duration-300 text-sm sm:text-base font-mono rounded-lg"
                    >
                      {skill}
                    </span>
                  ))}
